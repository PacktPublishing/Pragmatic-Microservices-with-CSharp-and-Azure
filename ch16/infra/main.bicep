...
module codebreakerevents 'codebreakerevents/codebreakerevents.module.bicep' = {
  name: 'codebreakerevents'
  scope: rg
  params: {
    location: location
...
module logs 'logs/logs.module.bicep' = {
  name: 'logs'
  scope: rg
  params: {
    location: location
...
output CODEBREAKEREVENTS_EVENTHUBSENDPOINT string = codebreakerevents.outputs.eventHubsEndpoint
