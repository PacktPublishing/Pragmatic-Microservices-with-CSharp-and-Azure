...
{
    private readonly Guid _gameId = Guid.Parse("DBDF4DD9-3A02-4B2A-87F6-FFE4BA1DCE52");
    ...
    public void GameEnded_Should_RecordValues()
    {
        ...
        Assert.Equal(-1, activeGamesMeasurements[^1].Value);
    ...
    public Game GetGame() => new(_gameId, "Game6x4", "Test", _gameStartTime, 4, 12)
    {
