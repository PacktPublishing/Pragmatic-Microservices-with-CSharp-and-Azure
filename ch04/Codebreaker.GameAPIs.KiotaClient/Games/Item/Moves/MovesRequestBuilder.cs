...
using System;
namespace Codebreaker.Client.Games.Item.Moves {
    /// <summary>
...
#nullable enable
        public async Task<SetMoveResponse?> PatchAsync(SetMoveRequest body, Action<MovesRequestBuilderPatchRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<SetMoveResponse> PatchAsync(SetMoveRequest body, Action<MovesRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(SetMoveRequest body, Action<MovesRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(SetMoveRequest body, Action<MovesRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new MovesRequestBuilderPatchRequestConfiguration();
        ...
        /// </summary>
        public class MovesRequestBuilderPatchRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new movesRequestBuilderPatchRequestConfiguration and sets the default values.
            /// </summary>
            public MovesRequestBuilderPatchRequestConfiguration() {
