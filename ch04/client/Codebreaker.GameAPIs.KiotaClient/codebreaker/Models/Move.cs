...
namespace Codebreaker.Client.Models
{
    ...
    public partial class Move : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Codebreaker.Client.Models.Move"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Codebreaker.Client.Models.Move CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Codebreaker.Client.Models.Move();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "guessPegs", n => { GuessPegs = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "id", n => { Id = n.GetGuidValue(); } },
                { "keyPegs", n => { KeyPegs = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
