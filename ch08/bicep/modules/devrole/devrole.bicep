metadata description = 'Creates a custom role to add all developers to it'
...
var roleDefinitionName = guid(resourceGroup().id, 'Codebreaker developers')

resource roleDefinition 'Microsoft.Authorization/roleDefinitions@2022-04-01' = {
  name: roleDefinitionName
  properties: {
    roleName: 'Codebreaker developers'
    description: 'Can access App Config configuration values, Azure Key Vault, Azure Cosmos DB'
    type: 'CustomRole'
    assignableScopes: [
      resourceGroup().id
    ]
